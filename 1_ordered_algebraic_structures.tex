\section{Estructuras algebráicas ordenadas}
  ...
  % \begin{proof}
  %   \begin{enumerate}
  %     \item \begin{tabular}{|c|} \hline $x \leq x \ \SU \ y$ \\\hline \end{tabular}
  %       \begin{eqnarray*}
  %         \textup{Si } x \leq y &\Rightarrow& x \leq x \ \SU \ y = y \Rightarrow x \leq y \\
  %         \textup{Si } y \leq x &\Rightarrow& x \leq x \ \SU \ y = x \Rightarrow x \leq x
  %       \end{eqnarray*}
  %     \item \begin{tabular}{|c|} \hline $x \ \IN \ y \leq x$ \\\hline \end{tabular}
  %       \begin{eqnarray*}
  %         \textup{Si } x \leq y \Rightarrow x \ \IN \ y &\leq& x \\
  %         x &\leq& x \\
  %         \textup{Si } y \leq x \Rightarrow x \ \IN \ y &\leq& x \\
  %         y &\leq& x
  %       \end{eqnarray*}
  %     \item \begin{tabular}{|c|} \hline $x \ \SU \ x = x \ \IN \ x = x$ \\\hline \end{tabular}
  %       \begin{eqnarray*}
  %         x \ \SU \ x &=& x \ \IN \ x = x \\
  %         x &=& x = x
  %       \end{eqnarray*}
  %       % TODO
  %     \item \begin{tabular}{|c|} \hline $x \ \SU \ y = y \ \SU \ x$ \\\hline \end{tabular}
  %       \begin{eqnarray*}
  %         \textup{Si } x \leq y \Rightarrow x \ \SU \ y &=& y \ \SU \ x \\
  %         y &=& y \\
  %         \textup{Si } y \leq x \Rightarrow x \ \SU \ y &=& y \ \SU \ x \\
  %         x &=& x
  %       \end{eqnarray*}
  %     \item \begin{tabular}{|c|} \hline $x \ \IN \ y = y \ \IN \ x$ \\\hline \end{tabular}
  %       \begin{eqnarray*}
  %         \textup{Si } x \leq y \Rightarrow x \ \IN \ y &=& y \ \IN \ x \\
  %         x &=& x \\
  %         \textup{Si } y \leq x \Rightarrow x \ \IN \ y &=& y \ \IN \ x \\
  %         y &=& y
  %       \end{eqnarray*}
  %     \item \begin{tabular}{|c|} \hline $x \leq y \Leftrightarrow x \ \SU \ y = y \Leftrightarrow x \ \IN
  %       \ y = x$ \\\hline \end{tabular}
  %       % TODO
  %     \item Ya que $x\mathsf{\;i\;}y\leq x$, (6) nos dice que $(x\mathsf{\;i\;}y)\; \SU\;x=x$, por lo cual $x\;\SU\;(x\mathsf{\;i\;}y)=x$.
  %     \item Similar a (7).
  %     \item Notese que $x\;\SU\;(y\;\SU\;z)$ es cota superior de $ \{x,y,z\}$ ya que onviamente $x\leq x\;\SU\;(y\;\SU\;z)$ y ademas
  %       $\displaystyle \begin{array}{rcl} y & \leq & (y\;\SU\;z)\leq x\;\SU\;(y\;\SU\;z) \\ z & \leq & (y\;\SU\;z)\leq x\;\SU\;(y\;\SU\;z) \end{array} $
  %
  %       Ya que $x\;\SU\;(y\;\SU\;z)$ es cota superior de $\{x,y\}$, tenemos que $x\;\SU\;y\leq x\;\SU\ (y\;\SU\;z)$, por lo cual $x\;\SU\;(y\;\SU\;z)$ es cota superior del conjunto $\{x\; \SU\;y,z\}$, lo cual dice que $(x\;\SU\;y)\;\SU\;z\leq x\;\SU\;(y\;\SU\;z)$. Analogamente se puede probar que $x\; \SU\;(y\;\SU\;z)\leq (x\;\SU\;y)\;\SU\;z$.
  %     \item Similar a (9).
  %     \item Ya que
  %       $\displaystyle \begin{array}{rcl} x & \leq & z\leq z\;\SU\;w \\ y & \leq & w\leq z\;\SU\;w \end{array} $
  %
  %       tenemos que $z\;\SU\;w$ es cota superior de $\{x,y\}$ lo cual dice que $x\;\SU\;y\leq z\;\SU\;w$. La otra desigualdad es analoga.
  %     \item Ya que
  %       $\displaystyle \begin{array}{rcl} (x\mathsf{\;i\;}y),(x\mathsf{\;i\;}z) & \leq & x \\ (x\mathsf{\;i\;}y),(x\mathsf{\;i\;}z) & \leq & y\;\SU\;z \end{array} $
  %
  %       tenemos que $(x\;\IN\;y),(x\mathsf{\;i\;}z)\leq x\mathsf{\;i\;}(y\; \SU\;z)$, por lo cual $(x\mathsf{\;i\;}y)\;\SU\;(x\mathsf{\;i\; }z)\leq x\mathsf{\;i\;}(y\;\SU\;z)$.
  %   \end{enumerate}
  % \end{proof}
  ...
  %       \]
  %
  %       \PN por lo cual $x \leq z$. Veamos ahora que $\sup (\{x,y\})=x\ \SU \y$. Es claro que $x\ \SU \y$ es una cota superior del conjunto $\{x,y\}$. Supongamos $x,y\leq z$. Entonces
  %     $\displaystyle (x\ \SU \y)\ \SU \z=x\ \SU \(y\ \SU \z)=x\; \mathsf{s\;}z=z, $
  %
  %     por lo que $x\ \SU \y\leq z$. Es decir que $x\ \SU \y$ es la menor cota superior.
  ...
  %
  %     lo cual le permitira al lector aplicar un razonamiento similar al usado en el caso de la operacion $\SU$. Supongamos que $u\;\SU\;v=v$. Entonces $u\mathsf{\;i\;}v=u\mathsf{\;i\;}(v\;\SU\;v)=u$. Reciprocamente si $u\mathsf{\;i\;}v=u$, entonces $u\;\SU\;v=(u\mathsf{ \;i\;}v)\;\SU\;v=v$, por lo cual $u\leq v$.
  %   \end{itemize}
  % \end{proof}
  %
  ...
  % \begin{lemma}
  %   \PN Sean $(L, \SU, \IN)$ y $(L^{\prime}, \SU^{\prime}, \IN^{\prime})$ reticulados y sea
  %   $F: (L, \SU, \IN) \rightarrow (L^{\prime}, \SU^{\prime}, \IN^{\prime})$ un homomorfismo,
  %   entonces $I_{F}$ es un subuniverso de $(L^{\prime}, \SU^{\prime}, \IN^{\prime})$.
  % \end{lemma}
  % \begin{proof}
  ...
  %   \begin{eqnarray*}
  %     a\;\SU^{\prime }\ b &=& F(x)\;\SU^{\prime }\ F(y)=F(x\mathsf{ \;s\;}y)\in I_{F} \\
  %     a\;\IN^{\prime }\ b & =& F(x)\;\IN^{\prime }\ F(y)=F(x\mathsf{ \;i\;}y)\in I_{F}
  %   \end{eqnarray*}
  %
  ...
  % \begin{lemma}
  %   \PN Sean $(L,\SU,\IN)$ y $(L^{\prime },\SU^{\prime }, \IN^{\prime })$ reticulados y sean $(L\leq )$ y $(L^{\prime },\leq ^{\prime })$ los posets asociados. Sea $F:L\rightarrow L^{\prime }$ una funcion. Entonces $F$ es un isomorfismo de $(L,\SU,\IN)$ en $ (L^{\prime },\SU^{\prime },\IN^{\prime })$ si y solo si $F$ es un isomorfismo de $(L,\leq )$ en $(L^{\prime },\leq ^{\prime })$.
  % \end{lemma}
  % \begin{proof}
  %   Supongamos $F$ es un isomorfismo de $(L,\SU,\IN)$ en $ (L^{\prime },\SU^{\prime },\IN^{\prime })$. Sean $x,y\in L$, tales que $x\leq y$. Tenemos que $y=x\mathsf{\;s\;}y$ por lo cual $F(y)=F(x \mathsf{\;s\;}y)=F(x)\mathsf{\;s^{\prime }\;}F(y)$, produciendo $F(x)\leq ^{\prime }F(y)$. En forma similar se puede ver que $F^{-1}$ es tambien un homomorfismo de $(L^{\prime },\leq ^{\prime })$ en $(L,\leq )$. Si $F$ es un isomorfismo de $(L,\leq )$ en $(L^{\prime },\leq ^{\prime })$, entonces el Lema 89 nos dice que $F$ y $F^{-1}$ respetan las operaciones de supremo e infimo por lo cual $F$ es un isomorfismo de $(L,\SU,\mathsf{ i})$ en $(L^{\prime },\SU^{\prime },\IN^{\prime })$. $\Box$
  % \end{proof}
  %
  ...
  %
  %   $\displaystyle \begin{array}{ccl} (x/\theta \mathsf{\;\tilde{s}\;}y/\theta )\;\mathsf{\tilde{s}}\;z/\theta & = & (x\mathsf{\;s\;}y)/\theta \;\mathsf{\tilde{s}}\;z/\theta \\ & = & ((x\mathsf{\;s\;}y)\;\SU\;z)/\theta \\ & = & (x\mathsf{\;s\;}(y\;\SU\;z))/\theta \\ & = & x/\theta \;\mathsf{\tilde{s}}\;(y\;\SU\;z)/\theta \\ & = & x/\theta \mathsf{\;\tilde{s}\;}(y/\theta \;\mathsf{\tilde{s}} \;z/\theta ) \end{array} $
  %
  ...
  % \begin{corollary}
  %   Sea $(L,\SU,\IN)$ un reticulado en el cual hay un elemento maximo $1$ (resp. minimo $0$). Entonces si $\theta $ es una congruencia sobre $(L,\SU,\IN)$, $1/\theta $ (resp. $0/\theta $) es un elemento maximo (resp. minimo) de $(L/\theta ,\mathsf{\tilde{s}},\mathsf{ \tilde{\imath}})$.
  % \end{corollary}
  % \begin{proof}
  ...
  % \begin{lemma}
  %   Si $F:(L,\SU,\IN)\rightarrow (L^{\prime },\SU^{\prime }, \IN^{\prime })$ es un homomorfismo de reticulados, entonces $\ker F$ es una congruencia sobre $(L,\SU,\IN)$.
  % \end{lemma}
  % \begin{proof}
  ...
  % \begin{lemma}
  %   Sea $(L,\SU,\IN)$ un reticulado y sea $\theta $ una congruencia sobre $(L,\SU,\IN)$. Entonces $\pi _{\theta }$ es un homomorfismo de $(L,\SU,\IN)$ en $(L/\theta ,\mathsf{\tilde{ s}},\mathsf{\tilde{\imath}})$. Ademas $\ker \pi _{\theta }=\theta $.
  % \end{lemma}
  % \begin{proof}
  ...
  % \begin{lemma}
  %   Si $F:(L,\SU,\IN,0,1)\rightarrow (L^{\prime },\SU ^{\prime },\IN^{\prime },0^{\prime },1^{\prime })$ un homomorfismo biyectivo, entonces $F$ es un isomorfismo
  % \end{lemma}
  % \begin{proof}
  ...
  % \begin{lemma}
  %   Si $F:(L,\SU,\IN,0,1)\rightarrow (L^{\prime },\SU ^{\prime },\IN^{\prime },0^{\prime },1^{\prime })$ es un homomorfismo, entonces $I_{F}$ es un subuniverso de $(L^{\prime },\SU ^{\prime },\IN^{\prime },0^{\prime },1^{\prime })$.
  % \end{lemma}
  % \begin{proof}
  ...
  % \begin{lemma}
  %   \PN Sea $(L, \SU, \IN, 0, 1)$ un reticulado acotado y $\theta$ una congruencia sobre $(L, \SU,
  %   \IN, 0, 1)$, entonces:
  %   \begin{enumerate}[a)]
  ...
  % \begin{lemma}
  %   \PN Si $F:(L, \SU, \IN, ^{c}, 0, 1) \rightarrow (L^{\prime}, \SU^{\prime}, \IN^{\prime},
  %   ^{c^{\prime}}, 0^{\prime}, 1^{\prime})$ un homomorfismo biyectivo, entonces $F$ es un isomorfismo.
  % \end{lemma}
  %
  % % Lemma 105: Sin prueba. Lemma 17.
  % \begin{lemma}
  %   \PN Si $F: (L, \SU, \IN, ^{c}, 0, 1) \rightarrow (L^{\prime}, \SU^{\prime },
  %   \IN^{\prime}, ^{c^{\prime}}, 0^{\prime}, 1^{\prime})$ es un homomorfismo, entonces $I_{F}$ es un subuniverso
  %   de $(L^{\prime}, \SU^{\prime}, \IN^{\prime}, ^{c^{\prime}}, 0^{\prime}, 1^{\prime})$.
  % \end{lemma}
  %
  % % Lemma 106: Sin prueba. Lemma 18.
  % \begin{lemma}
  %   \PN Si $F: (L, \SU, \IN, ^{c}, 0, 1) \rightarrow (L^{\prime}, \SU^{\prime},
  %   \IN^{\prime}, ^{c^{\prime}}, 0^{\prime}, 1^{\prime})$ es un homomorfismo de reticulados complementados,
  %   entonces $\ker F$ es una congruencia sobre $(L, \SU, \IN, ^{c}, 0, 1)$.
  % \end{lemma}
  %
  % % Lemma 107: Sin prueba. Lemma 19.
  % \begin{lemma}
  %   \PN Sea $(L, \SU, \IN, ^{c}, 0, 1)$ un reticulado complementado y sea $\theta$ una congruencia sobre
  %   $(L, \SU, \IN, ^{c}, 0, 1)$.
  %   \begin{enumerate}[a)]
  %     \item $(L/\theta, \mathsf{\tilde{s}}, \mathsf{\tilde{\imath}}, ^{\tilde{c}}, 0/\theta, 1/\theta)$ es un reticulado
  %       complementado.
  %     \item $\pi_{\theta}$ es un homomorfismo de $(L, \SU, \IN, ^{c}, 0, 1)$ en $(L/\theta,
  ...
  % \begin{lemma}
  %   Sea $(L,\SU,\IN)$ un reticulado. Son equivalentes:
  %   (1) $x\mathsf{\;i\;}(y\;\SU\;z)=(x\mathsf{\;i\;}y)\;\SU \;(x\mathsf{\;i\;}z)$, cualesquiera sean $x,y,z\in L$
  %   (2) $x\;\SU\;(y\mathsf{\;i\;}z)=(x\mathsf{\;s\;}y)\mathsf{\;i\; }(x\;\SU\;z)$, cualesquiera sean $x,y,z\in L$.
  % \end{lemma}
  % \begin{proof}
  %   (1)$\Rightarrow $(2). Notese que
  %
  %   $\displaystyle \begin{array}{rcl} (x\mathsf{\;s\;}y)\mathsf{\;i\;}(x\;\SU\;z) & =& ((x\mathsf{\;s\;}y) \mathsf{\;i\;}x)\;\SU\;((x\mathsf{\;s\;}y)\mathsf{\;i\;}z) \\ & =& (x\;\SU\;(z\mathsf{\;i\;}(x\mathsf{\;s\;}y)) \\ & =& (x\;\SU\;((z\;\mathsf{i\;}x)\mathsf{\;s\;}(z\;\mathsf{i\;}y)) \\ & =& (x\;\SU\;(z\;\mathsf{i\;}x))\mathsf{\;s\;}(z\;\mathsf{i\;}y) \\ & =& x\mathsf{\;s\;}(z\;\mathsf{i\;}y) \\ & =& x\mathsf{\ s\ }(y\ \mathsf{i\ }z) \end{array} $
  %
  ...
  % \begin{lemma}
  %   Si $(L,\SU,\IN,0,1)$ un reticulado acotado y distributivo, entonces todo elemento tiene a lo sumo un complemento.
  % \end{lemma}
  % \begin{proof}
  %   Supongamos $x\in L$ tiene complementos $y,z$. Se tiene
  %
  %   $\displaystyle y=y\;\mathsf{i\;}1=y\;\mathsf{i\;}(x\ \SU \z)=(y\;\mathsf{i\;}x)\; \mathsf{s\;}(y\;\mathsf{i\;}z)=0\ \SU \(y\;\mathsf{i\;}z)=y\;\mathsf{ i\;}z, $
  %
  ...
  % \end{lemma}
  % \begin{proof}
  %   Ya que $S\subseteq \lbrack S)$, tenemos que $[S)\neq \varnothing $. Claramente $[S)$ cumple la propiedad (3). Veamos cumple la (2). Si $y\geq s_{1}\; \mathsf{i\;}s_{2}\;\mathsf{i\;}\dotsc\;\mathsf{i\;}s_{n}$ y $z\geq t_{1}\; \mathsf{i\;}t_{2}\;\mathsf{i\;}$\dotsc$\;\mathsf{i\;}t_{m}$, con $ s_{1},s_{2}, \dotsc, s_{n}$, $t_{1},t_{2}, \dotsc, t_{m}\in S$, entonces
  %
  %   $\displaystyle y\;\mathsf{i\;}z\geq s_{1}\;\mathsf{i\;}s_{2}\;\mathsf{i\;}\dotsc\;\mathsf{i\;} s_{n}\;\mathsf{i\;}t_{1}\;\mathsf{i\;}t_{2}\;\mathsf{i\;}\dotsc\;\mathsf{i\;} t_{m}, $
  %
  %   lo cual prueba (2).
  % \end{proof}
  %
  ...
  % \begin{theorem}
  %   (Teorema del Filtro Primo) Sea $(L,\SU,\IN)$ un reticulado distributivo y $F$ un filtro. Supongamos $x_{0}\in L-F$. Entonces hay un filtro primo $P$ tal que $x_{0}\notin P$ y $F\subseteq P$.
  % \end{theorem}
  % \begin{proof}
  %   Sea
  %
  ...
  %   $\displaystyle x_{0}\geq p_{1}\;\mathsf{i\;}\dotsc\;\mathsf{i\;}p_{n}\;\mathsf{i\;}x $
  %
  %   Ya que $x_{0}\in \lbrack P\cup \{y\})$, tenemos que hay elementos $ q_{1}, \dotsc, q_{m}\in P$, tales que
  %   $\displaystyle x_{0}\geq q_{1}\;\mathsf{i\;}\dotsc\;\mathsf{i\;}q_{m}\;\mathsf{i\;}y $
  %
  %   Si llamamos $p$ al siguiente elemento de $P$
  %   $\displaystyle p_{1}\;\mathsf{i\;}\dotsc\;\mathsf{i\;}p_{n}\;\mathsf{i\;}q_{1}\;\mathsf{i\;} \dotsc\;\mathsf{i\;}q_{m} $
  %
  %   tenemos que
  %   $\displaystyle \begin{array}{rcl} x_{0} & \geq & p\;\mathsf{i\;}x \\ x_{0} & \geq & p\;\mathsf{i\;}y \end{array} $
  %
  %   Se tiene que $x_{0}\geq (p\;\mathsf{i\;}x)\ \SU \(p\;\mathsf{i\;} y)=p\;\mathsf{i\;}(x\ \SU \y)\in P$, lo cual es absurdo ya que $ x_{0}\notin P$. $\Box$
  % \end{proof}
  %
  % % Corollary 113: Con prueba. Corollary 25.
  % \begin{corollary}
  %   Sea $(L,\SU,\IN,0,1)$ un reticulado acotado distributivo. Si $ \varnothing \neq S\subseteq L$ es tal que $s_{1}\;\mathsf{i\;}s_{2}\;\mathsf{ i\;}\dotsc\;\mathsf{i\;}s_{n}\neq 0$, para cada $s_{1}, \dotsc, s_{n}\in S$, entonces hay un filtro primo que contiene a $S$.
  % \end{corollary}
  % \begin{proof}
  ...
  % \begin{lemma}
  %   Sea $(B,\SU,\IN,^{c},0,1)$ un algebra de Boole. Entonces para un filtro $F\subseteq B$ las siguientes son equivalentes:
  %   (1) $F$ es primo
  ...
  %
  %   $\displaystyle y\geq x^{c}\;\mathsf{i\;}y=(x^{c}\;\mathsf{i\;}x)\ \SU \(x^{c}\; \mathsf{i\;}y)=x^{c}\;\mathsf{i\;}(x\ \SU \y)\in F, $
  %
  ...
  %
  %   $\displaystyle b=b\;\mathsf{i\;}(e\ \SU \e^{c})=(b\;\mathsf{i\;}e)\ \SU \(b\; \mathsf{i\;}e^{c})=b\;\mathsf{i\;}e, $
  %
  ...
  % \begin{theorem}
  %   (Rasiova y Sikorski) Sea $(B,\SU,\IN,^{c},0,1)$ un algebra de Boole. Sea $x\in B$, $x\neq 0$. Supongamos que $A_{1},A_{2},\dotsc$ son subconjuntos de $B$ tales que existe $\inf (A_{j})$, para cada $j=1,2\dotsc.$ Entonces hay un filtro primo $P$ el cual cumple:
  %   (a) $x\in P$
  ...
  %
  %   (1) $b_{0}=x$
  %   (2) $b_{0}\;\mathsf{i\;}$\dotsc$\;\mathsf{i\;}b_{n}\neq 0$, para cada $ n\geq 0$
  %   (3) $b_{j}=a_{j}$ o $b_{j}^{c}\in A_{j}$, para cada $j\geq 1$.
  %   Definamos $b_{0}=x$. Supongamos ya definimos $b_{0}, \dotsc, b_{n}$, veamos como definir $b_{n+1}$. Si $(b_{0}\;\mathsf{i\;}\dotsc\;\mathsf{i\;} b_{n})\;\mathsf{i\;}a_{n+1}\neq 0$, entonces definamos $b_{n+1}=a_{n+1}$. Si $(b_{0}\;\mathsf{i\;}\dotsc\;\mathsf{i\;}b_{n})\;\mathsf{i\;}a_{n+1}=0$, entonces por el lema anterior, tenemos que hay un $e\in A_{n+1}$ tal que $ (b_{0}\;\mathsf{i\;}\dotsc\;\mathsf{i\;}b_{n})\;\mathsf{i\;}e^{c}\neq 0$, lo cual nos permite definir $b_{n+1}=e^{c}$.
  %
