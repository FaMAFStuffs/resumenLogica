\section{Estructuras algebráicas ordenadas}
  ...
  % \begin{theorem}
  %   \PN \textbf{(Rasiova y Sikorski)} Sea $(B, \SU, \IN, ^{c}, 0, 1)$ un álgebra de Boole. Sea $x \in B$, $x \neq 0$.
  %   Supongamos que $A_{1}, A_{2}, \dotsc$ son subconjuntos de $B$ tales que existe $\inf(A_{j})$, para cada $j = 1, 2
  %   \dotsc$, entonces hay un filtro primo $P$ el cual cumple:
  %   \begin{enumerate}[a)]
  %     \item $x \in P$
