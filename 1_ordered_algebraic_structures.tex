\section{Estructuras algebráicas ordenadas}
  ...
  \end{lemma}
  \begin{proof}
    \PN Ya que $F$ es un homomorfismo de $(L, \SU, \IN, ^{c}, 0, 1)$ en $(L^{\prime}, \SU^{\prime}, \IN^{\prime},
  ...
  \begin{lemma} \label{lemma_23}
    \PN (\textbf{Zorn}) Sea $(P, \leq)$ un poset y supongamos que cada cadena de $(P, \leq)$ tiene una cota superior,
    entonces existe un elemento maximal en $(P, \leq)$.
  \end{lemma}
  ...
  \begin{lemma} \label{lemma_27}
    ...
    B$, entonces si $b \ \IN \ a = 0$ existe un $e \in A$ tal que $b \ \IN \ e^{c} \neq 0$.
  \end{lemma}
  \begin{proof}
