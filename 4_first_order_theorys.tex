\section{Teorias de primer orden}
  ...
  \end{lemma}
  \begin{proof}
    \PN Solo hay que probar la unicidad la cual sigue de la Proposicion 128.
  \end{proof}
  ...
  \begin{lemma}
    ...
    \begin{enumerate}
      ...
      n(\mathbf{\varphi})$. Supongamos que $\mathbf{J}_{i} = \mathrm{HIPOTESIS}\bar{k}$ y que $\mathbf{J}_{j} =
  ...
  % % Lemma 77. Con prueba.
  % \begin{lemma}
  %   \PN Dada una teoria $T = (\Sigma, \tau)$, el par $(S^{\tau}/\mathrm{\dashv \vdash}, \leq)$ es un reticulado en el cual:
  %   \begin{eqnarray*}
