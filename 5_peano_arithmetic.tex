\section{La aritmética de Peano}
  ...
  % \end{proof}
  %
  % % Proposition 176. Con prueba. Proposition 87.
  % \begin{proposition}
  ...
  % \end{proof}
  %
  % % Lemma 182. Con prueba. Lemma 93.
  % \begin{lemma}
  %   \PN Los conjuntos $T^{\tau_{A}^{e}}, F^{\tau_{A}^{e}}, T^{\tau_{A}}$ y $F^{\tau_{A}}$ son $A$-PR.
  % \end{lemma}
  % \begin{proof}
  ...
  % \end{proof}
  %
  % % Lemma 183. Con prueba. Lemma 94.
  % \begin{lemma}
  %   \PN Los siguientes predicados son $A$-PR:
  %   \begin{enumerate}[(1)]
  %     \item $"v$ ocurre libremente en $\varphi$ a partir de $i": \omega \times Var \times F^{\tau_{A}^{e}} \rightarrow
  %       \omega$
  %     \item $"v \in Li(\varphi)": Var \times F^{\tau_{A}^{e}} \rightarrow \omega$
  %     \item $"v$ es sustituible por $t$ en $\varphi": Var \times T^{\tau_{A}^{e}} \times F^{\tau_{A}^{e}} \rightarrow
  %       \omega$
  %   \end{enumerate}
  % \end{lemma}
  % \begin{proof}
  ...
  % \end{proof}
  %
  % % Lemma 186. Con prueba. Lemma 97.
  % \begin{lemma}
  %   \PN Sea $B$ un alfabeto finito. Sea $S\subseteq B^{\ast}$ un conjunto $B$-PR. El conjunto $S^{+}$ es $B$-PR.
  % \end{lemma}
  % \begin{proof}
  ...
  % \end{proof}
  %
  % % Lemma 187. Con prueba. Lemma 98.
  % \begin{lemma}
  %   \PN Los conjuntos $ModPon^{\tau_{A}^{e}}$, $Elec^{\tau_{A}^{e}}$, $Reem^{\tau_{A}^{e}}$, $Reem_{2}^{\tau_{A}^{e}}$,
  %   etc, son $A$-PR.
  % \end{lemma}
  % \begin{proof}
  ...
  % \end{proof}
  %
  % % Lemma 188. Con prueba. Lemma 99.
  % \begin{lemma}
  %   \PN El predicado $"\psi$ se deduce de $\varphi$ por generalización con constante $c": S^{\tau_{A}^{e}} \times
  %   S^{\tau_{A}^{e}} \times Aux \rightarrow \omega$ es $A$-PR.
  % \end{lemma}
  % \begin{proof}
  ...
  % \end{proof}
  %
  % % Lemma 189. Sin prueba. Lemma 100.
  % \begin{lemma}
  %   \PN El predicado $"\psi$ se deduce de $\varphi$ por elección con constante $e": S^{\tau_{A}^{e}} \times
  %   S^{\tau_{A}^{e}} \times Aux \rightarrow \omega$ es $A$-PR. Definamos
  %   \[
  %     AxLog^{\tau_{A}^{e}} = \{\varphi \in S^{\tau_{A}^{e}}: \varphi \text{ es un axioma lógico}\}
  %   \]
  % \end{lemma}
  %
  % % Lemma 190. Sin prueba. Lemma 101.
  % \begin{lemma}
  %   \PN $AxLog^{\tau_{A}^{e}}$ es $A$-PR.
  % \end{lemma}
  %
  % % Lemma 191. Sin prueba. Lemma 102.
  % \begin{lemma}
  %   \PN Las funciones:
  %   \begin{equation*}
  %     \begin{aligned}
  ...
  % \end{lemma}
  %
  % % Lemma 192. Con prueba. Lemma 103.
  % \begin{lemma}
  %   \PN $Just$ es $B$-PR. Las funciones:
  %   \begin{equation*}
  %     \begin{aligned}
  ...
  % \end{proof}
  %
  % % Lemma 193. Sin prueba. Lemma 104.
  % \begin{lemma}
  %   \PN El conjunto $\{\mathbf{J} \in Just^{+}: \mathbf{J}$ es balanceada $\}$ es $B$-PR.
  % \end{lemma}
  %
  % % Lemma 194. Sin prueba. Lemma 105.
  % \begin{lemma}
  %   \[
  %     \begin{array}{rcl}
  ...
  % \end{lemma}
  %
  % % Lemma 195. Sin prueba. Lemma 106.
  % \begin{lemma}
  %   \[
  %     \begin{array}{rcl}
  ...
  % \end{lemma}
  %
  % % Lemma 196. Sin prueba. Lemma 107.
  % \begin{lemma}
  %   \PN Sea $(\Sigma, \tau_{A})$ una teoría tal que $\Sigma$ es $A$-recursivo (resp. $A$-RE), entonces
  %   $Pruebas_{(\Sigma, \tau_{A})}$ es $(A \cup B)$-recursivo (resp. $(A \cup B)$-RE).
  % \end{lemma}
  %
  % % Proposition 197. Con prueba. Proposition 108.
  % \begin{lemma}
  %   \PN Si $(\Sigma, \tau_{A})$ es una teoría tal que $\Sigma$ es $A$-RE., entonces $Teo_{(\Sigma, \tau_{A})}$ es
  %   $A$-RE.
  % \end{lemma}
  % \begin{proof}
  ...
  % \end{proof}
  %
  % % Lemma 198. Con prueba. Proposition 109.
  % \begin{lemma}
  ...
  % \end{proof}
  %
  % % Proposition 199. Con prueba. Proposition 110.
  % \begin{proposition}
  ...
  % \end{proof}
  %
  % % Lemma 200. Con prueba. Lemma 111.
  % \begin{lemma}
  ...
  % \end{proof}
  %
  % % Lemma 201. Con prueba. Lemma 112.
  % \begin{lemma}
  %   \PN Si $Verd_{\mathbf{\omega}}$ es $A$-RE, entonces es $A$-recursivo.
  % \end{lemma}
  % \begin{proof}
  ...
  % \end{proof}
  %
  % % Lemma 202. Con prueba. Lemma 113.
  % \begin{lemma}
  %   \PN $Verd_{\mathbf{\omega}}$ no es $A$-RE.
  % \end{lemma}
  % \begin{proof}
  ...
  % \end{proof}
  % 
  % % Theorem 203. Con prueba. Theorem 114.
  % \begin{theorem}
  %   \PN (Godel) Si $\Sigma \subseteq Verd_{\mathbf{\omega}}$ es $A$-RE, entonces $Teo_{(\Sigma, \tau_{A})} \subsetneq
  %   Verd_{\mathbf{\omega}}$.
  % \end{theorem}
  % \begin{proof}
  ...
  % \end{proof}
  %
  % % Corollary 204. Sin prueba. Corollary 115.
  % \begin{corollary}
